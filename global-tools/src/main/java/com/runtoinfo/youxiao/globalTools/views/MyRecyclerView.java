...
public class MyRecyclerView extends RecyclerView {
    ...
    private UniversalRecyclerAdapter.OnItemClickListener mListener;
    private int item_delete;
    private int itemLayout;
    /**设置删除监听*/
    public void setmListener(UniversalRecyclerAdapter.OnItemClickListener mListener) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mDeleteBtnState == 0) {
                    ...
                    mItemLayout = viewHolder.getView(itemLayout);//.itemView;
