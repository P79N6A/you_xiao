...
import com.runto.cameraview.listener.CaptureListener;
import com.runto.cameraview.util.CheckPermission;

import static com.runto.cameraview.JCameraView.BUTTON_STATE_BOTH;
import static com.runto.cameraview.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.runto.cameraview.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    public CaptureButton(Context context, int size) {
        ...
        button_state = BUTTON_STATE_ONLY_CAPTURE;  //初始化按钮为只能拍照
