package com.runtoinfo.youxiao.service;
...
import com.runtoinfo.youxiao.utils.IOUtils;
import com.runtoinfo.youxiao.utils.InstallUtil;
import com.runtoinfo.youxiao.utils.SystemManager;
...
public class DownloadManagerService extends Service {
    ...
    public class DownloadBinder extends Binder {
        ...
        public long startDownload(String apkUrl){
            //点击下载,删除原有的APK
            IOUtils.clearApk(DownloadManagerService.this,"YuLin.apk");
            //使用DownLoadManager来下载
            Log.e("Url", apkUrl);
            DownloadManager.Request request = new DownloadManager.Request(Uri.parse(apkUrl));
            //将文件下载到自己的Download文件夹下,必须是External的,这是DownloadManager的限制
            File file = new File(getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "YuLin.apk");
